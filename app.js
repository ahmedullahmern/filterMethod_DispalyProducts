...
var drowpdown = document.getElementById("drowpdown")
...
function btn_price(){
    ...
    var fil = products.filter((data,ind)=> data.price<input_search.value)
    displayProducts(fil)
}


drowpdown.addEventListener("change",function(){
    if (this.value === "all") {
        displayProducts(products)
    } else {
        var filbyTitle = products.filter((data, ind) => data.category == this.value)
        displayProducts(filbyTitle)
    }
})